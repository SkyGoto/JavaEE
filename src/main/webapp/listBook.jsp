...
<head>
    ...
    <script  language="javascript">
        function doDelete(isbn){
             ...
             if (flag) {
                 window.location.assign("deleteBook?book.isbn="+isbn);
             }
        }
        function doUpdate(isbn){
            window.location.assign("edit?book.isbn="+isbn);
        }
...
<table border="1" width="700">
    ...
    <tr>
        ...
        <td><div style="display: inline-block" onclick="doreaddate('<s:property value="#book.isbn"/>')">简介</div>&nbsp;
            <div style="display: inline-block" onclick="doUpdate('<s:property value="#book.isbn"/>')">修改</div>&nbsp;
            <div style="display: inline-block" onclick="doDelete('<s:property value="#book.isbn"/>')">删除</div></td>
    </tr>
    </s:iterator>
