...
<head>
    ...
    <script  language="javascript">
        function doDelete(isbn){
             var flag = confirm("是否确定还此书?");
             if (flag) {
                 window.location.assign("lendedBook?book.isbn="+isbn);
             }
        }
...
<table border="1" width="700">
    ...
    <s:iterator var="book" value="#session.lendedBook">
    <tr>
        ...
        <td>
            <div style="display: inline-block" onclick="doDelete('<s:property value="#book.isbn"/>')">还书</div></td>
    </tr>
    </s:iterator>
